...
<template>
    <div class="max-w-md rounded-lg p-6 shadow">
        <h2 class="mb-4 text-xl font-bold text-white">Your Agenda</h2>
        ...
        <div v-if="!isConnected" class="py-8 text-center">
            ...
            <a
                href="/auth/outlook"
                class="rounded bg-(--blue) px-4 py-2 text-white transition hover:bg-blue-700"
            >
            ...
            <div v-for="(events, date) in groupedEvents" :key="date">
                ...
                <ul class="space-y-3">
                    <li
                        ...
                        :key="event.id"
                        class="border-l-4 border-blue-500 py-1 pl-3"
                    >
                        <a
                            :href="event.webLink"
                            target="_blank"
                            class="-ml-1 block rounded p-1 transition hover:bg-gray-50"
                        >
