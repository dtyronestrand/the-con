            ...
            >
                ...
                <div class="mx-4 mt-2 flex flex-row flex-wrap gap-4">
                    <div
                        ...
                        :key="service.id"
                        class="group relative focus-within:opacity-100"
                    >
                        <Button
                            classList="round"
                        ...
                        <button
                            ...
                            class="absolute -top-2 -right-2 flex h-6 w-6 items-center justify-center rounded-full bg-gray-700 text-white opacity-0 transition-opacity group-focus-within:opacity-100 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-blue-500"
                            title="Edit service"
        ...
        >
            ...
            >
                <button
                    type="button"
                    @click="closeModal"
                    class="float-right mb-4 text-white focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none"
                ...
                <div class="mb-4">
                    ...
                    <div class="flex flex-row gap-4">
                        ...
                        <button
                            class="text-3xl text-white focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none"
                            type="button"
                            @click="newCategory = !newCategory"
                            aria-label="Toggle new category input"
                            title="Toggle new category input"
                        >
                            <span aria-hidden="true">+</span>
                        </button>
                    </div>
