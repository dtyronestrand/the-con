        ...
        >
            ...
            >
                <button
                    type="button"
                    @click="closeModal"
                    class="float-right mb-4 rounded text-white focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
                ...
                <div class="mb-4">
                    ...
                    <div class="flex flex-row gap-4">
                        ...
                        <button
                            class="rounded text-3xl text-white focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
                            type="button"
