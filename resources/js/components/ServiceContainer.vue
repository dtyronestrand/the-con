                ...
                <div class="mx-4 mt-2 flex flex-row flex-wrap gap-4">
                    ...
                    >
                        ...
                        <button
                            ...
                            class="absolute -top-2 -right-2 flex h-6 w-6 items-center justify-center rounded-full bg-gray-700 text-white opacity-0 transition-opacity group-hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                            title="Edit service"
        ...
        >
            ...
            >
                <button
                    type="button"
                    @click="closeModal"
                    class="float-right mb-4 rounded text-white focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none"
                ...
                <div class="mb-4">
                    ...
                    <div class="flex flex-row gap-4">
                        ...
                        <button
                            class="rounded text-3xl text-white focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none"
                            type="button"
