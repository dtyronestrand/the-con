            ...
            <form @submit.prevent="saveForm" class="space-y-4">
                ...
                <div v-if="taskToUpdate">
                    <div class="mb-2 flex items-center justify-between">
                        ...
                        <button
                            ...
                            class="btn btn-sm btn-success focus-visible:ring-success focus-visible:ring-2 focus-visible:outline-none"
                    ...
                    >
                        ...
                        <button
                            ...
                            class="btn btn-sm btn-error focus-visible:ring-error focus-visible:ring-2 focus-visible:outline-none"
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button
                        ...
                        title="Delete task"
                        class="flex cursor-pointer items-center justify-center p-2 text-white hover:text-red-500 focus-visible:text-red-500 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none"
                    >
                        <Trash2 />
                    </button>
                </div>
