<template>
    <div
        ...
        class="group col-span-2 flex cursor-pointer flex-row justify-between rounded-sm border-b border-(--indigo) text-white focus-within:ring-2 focus-within:ring-(--indigo)"
    >
        <p
            ...
            role="button"
            tabindex="0"
            class="w-full rounded-sm focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
        >
            {{ props.task.name }}
        </p>
        <Checkmark
