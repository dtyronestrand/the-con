<template>
    ...
    >
        <p
            ...
            role="button"
            tabindex="0"
            class="rounded focus-visible:ring-2 focus-visible:ring-(--indigo) focus-visible:ring-offset-2 focus-visible:outline-none"
        >
            {{ props.task.name }}
        </p>
        <Checkmark
            ...
            type="checkbox"
            class="opacity-0 group-focus-within:opacity-100 group-hover:opacity-100 focus-within:opacity-100"
