<template>
    <div
        ...
        class="group col-span-2 flex flex-row justify-between border-b border-panel-primary text-on-surface"
    >
        <p
            ...
            role="button"
            tabindex="0"
            class="cursor-pointer rounded focus-visible:ring-2 focus-visible:ring-current focus-visible:outline-none"
        >
            {{ props.task.name }}
        </p>
        <Checkmark
