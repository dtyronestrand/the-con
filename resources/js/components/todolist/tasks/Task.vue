<template>
    ...
    >
        <p
            ...
            class="-mx-1 rounded px-1 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
        >
            {{ props.task.name }}
        </p>
        <Checkmark
            ...
            type="checkbox"
            class="opacity-0 transition-opacity group-focus-within:opacity-100 group-hover:opacity-100 focus-within:opacity-100"
