<template>
    ...
    >
        <p
            ...
            class="rounded focus-visible:outline focus-visible:outline-2 focus-visible:outline-white"
        >
            {{ props.task.name }}
        </p>
        <Checkmark
            ...
            :ariaLabel="
                props.task.done
                    ? `Mark ${props.task.name} as incomplete`
                    : `Mark ${props.task.name} as complete`
            "
