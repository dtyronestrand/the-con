<template>
    ...
    >
        <p
            ...
            role="button"
            tabindex="0"
            class="cursor-pointer rounded focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-1 focus-visible:ring-offset-black focus-visible:outline-none"
        >
            {{ props.task.name }}
        </p>
        <Checkmark
