<template>
    ...
    >
        <p
            ...
            role="button"
            tabindex="0"
            class="rounded-sm focus-visible:ring-2 focus-visible:ring-[var(--indigo)] focus-visible:ring-offset-2 focus-visible:ring-offset-black focus-visible:outline-none"
        >
            {{ props.task.name }}
        </p>
        <Checkmark
