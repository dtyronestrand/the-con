        ...
        >
            <div class="flex space-x-1">
                <button
                    ...
                    :key="c"
                    @click="form.color = c"
                    class="h-4 w-4 rounded-full border border-black/10 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1"
            ...
            <button
                @click="deleteNote"
                @mouseup.stop
                class="rounded-sm p-0.5 text-red-500 hover:text-red-700 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-1"
