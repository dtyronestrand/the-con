<template>
    <div
        ...
        :class="classes"
        class="relative m-0 box-border flex w-15 grow flex-row justify-end border-t-2 border-ink text-right font-display text-sm tracking-tight text-on-surface uppercase md:w-30"
        :style="{
    ...
    >
        <span class="mx-auto text-center text-sm md:text-base">
            <slot />
        </span>
    </div>
</template>
